...
})(
  {
        ...
        var displayMap = function displayMap(locations) {
          ...
          locations.forEach(function (loc) {
            ...
            new mapboxgl.Marker({
              ...
              .addTo(map); // Extends the map bounds to include the current location
      ...
      function (require, module, exports) {
        ...
        var showAlert = function showAlert(type, message) {
          ...
          var markup = '<div class="alert alert--'
            .concat(type, '">')
            .concat(message, '</div>">'); // Inside the body, but right at the beginning.
                      ...
                      case 4:
                        ...
                        if (res.status === 200)
                          (0, _alert.showAlert)(
                            ...
                            "".concat(
                              type.toUpperCase(),
                              " updated successfully! Reload for changes to take place!"
                            )
                          );
                        _context.next = 12;
                        break;
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: "GET",
                          url: "http://localhost:3000/api/v1/bookings/checkout/".concat(
                            tourId
                          ), // withCredentials: true,
                        });
    ...
    "index.js": [
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          ).innerHTML = "Updating..."; // We can't use .value here, as value is only useful when 2 buttons have the same name and we want them to submit different values when clicked. It doesn't change the text on the button in any way.
      ...
      },
      {
        ...
        "./mapBox": "mapBox.js",
        "./login": "login.js",
        "./updateUserData": "updateUserData.js",
        "./alert": "alert.js",
        "./stripe": "stripe.js",
      },
    ],
